...
<section class="bg-gray-50 dark:bg-gray-900">
    <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto h-screen">
        ...
        <div class="mb-6 text-2xl font-semibold text-gray-900 dark:text-white lg:mr-96 md:mr-0">
                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-6" action="#">
                        ...
                        <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                            Pas encore de compte? <a href="#" class="font-medium text-blue-600 hover:underline dark:text-blue-500">S'inscrire</a>
                        </p>
                    </form>
                </div>
            </div>

            <div class="hidden lg:block ml-4 items-center">
                <img src="{{asset('img/login2.svg')}}" alt="Illustration" class=" h-auto">
            </div>
        </div>
    </div>
</section>
            ...
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6" action="#">
                    ...
                    <div>
                        ...
                        <input type="confirm-password" name="confirm-password" id="confirm-password"  class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required="">
                    </div>
                    ...
                    <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                        Vous avez déjà un compte? <a href="#" class="font-medium text-blue-600 hover:underline dark:text-blue-500">Connectez-vous ici</a>
                    </p>
                </form>
            </div>
        </div>
